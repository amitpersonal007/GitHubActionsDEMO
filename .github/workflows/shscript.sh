...
#
#********START USER_INPUTS*********
TESTSIGMA_API_KEY=eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJlOWRmMWNiOS1lZTZkLTQyNTMtODNjMi04NjZmY2JlMTI0MWIiLCJkb21haW4iOiJ0ZXN0c2lnbWF0ZWNoLmNvbSIsInRlbmFudElkIjoyODE3fQ.oOa93_77066kFU7_TBWkH9g0ihBLgeW7qd869sN85ZYA4BE2d9zoyNA9vCdt1MKXh_7AIjiXDUmid4PfKjMx6A
MAX_WAIT_TIME_FOR_SCRIPT_TO_EXIT=60
JUNIT_REPORT_FILE_PATH=./junit-report-$(date +"%Y%m%d%H%M").xml
BUILD_NO=$(date +"%Y%m%d%H%M")
TESTSIGMA_TEST_PLAN_ID=1373
#********END USER_INPUTS***********
